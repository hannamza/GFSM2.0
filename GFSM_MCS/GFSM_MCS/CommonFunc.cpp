...
WCHAR* CCommonFunc::Utf8ToWCHAR(char* utf8)
{
	int nLen = MultiByteToWideChar(CP_UTF8, 0, utf8, strlen(utf8), NULL, NULL) + 1;
	memset(g_wszChar, 0x00, nLen * sizeof(WCHAR));
	MultiByteToWideChar(CP_UTF8, 0, utf8, strlen(utf8), g_wszChar, nLen);
