...
CString CGlobal::GetBitmapFileName(UINT nBitmapID)
{
	...
	case IDX_BMP_BTN_TAB					:	return _T("skin\\btn_tab.bmp");					break;
	case IDX_BMP_BTN_TAB2					:	return _T("skin\\btn_tab2.bmp");				break;
	case IDX_BMP_LIST_HEADER_SHADOW			:	return _T("skin\\list_header_shadow.bmp");		break;
	case IDX_BMP_LIST_HEADER_DIVISION		:	return _T("skin\\list_header_division.bmp");	break;
	case IDX_BMP_BTN_BASE2					:	return _T("skin\\btn_base2.bmp");				break;
	case IDX_BMP_BTN_SEARCH_UP				:	return _T("skin\\search_up.bmp");				break;
	case IDX_BMP_BTN_SEARCH_DOWN			:	return _T("skin\\search_down.bmp");				break;
	}
	return _T("");
}
...
CString CGlobal::GetIconFileName(UINT nIconID)
{
	...
	case IDX_ICON_UP							:	return _T("skin\\up.ico");						break;
	case IDX_ICON_DOWN							:	return _T("skin\\down.ico");					break;
	case IDX_ICON_SEARCH						:	return _T("skin\\search.ico");					break;
	case IDX_ICON_REFRESH						:	return _T("skin\\refresh.ico");					break;
	}
	return _T("");
}
...
CFont * CGlobal::SetFont(UINT nFontID, CString sFaceName, UINT nFontSize, BOOL bBold/*=FALSE*/)
{
	...
	_tcscpy_s( logFont.lfFaceName, sFaceName.GetBuffer(0) );
...
CSize CGlobal::FormatText(CString& sText, CDC* pDC, int nWidth)
{
	...
	CFont* pFont = GetFont(IDX_FONT_MEDIUM);
