...
#define		COMBOBOX_CHANGE_NOTIFY		(WM_USER+1901)
#define		CHECKBOX_CHANGE_NOTIFY		(WM_USER+1902)
#define		EDITBOX_CHANGE_NOTIFY		(WM_USER+1903)
...
public:
	static void ResizeListColumn(CXListCtrl& list, const int* arrWidth);
	static void InitList(CXListCtrl& list, const TCHAR** pszTitle);
...
public:
	CFont	m_listHeaderFont;		// 윈도우 11에서 헤더 텍스트 삐져 나오는 현상없애기 위한 폰트
