...
#define	IDX_BMP_BTN_TAB						21
#define	IDX_BMP_BTN_TAB2					22
#define IDX_BMP_LIST_HEADER_SHADOW			23		//
#define IDX_BMP_LIST_HEADER_DIVISION		24		//
#define IDX_BMP_BTN_BASE2					25		//	
#define IDX_BMP_BTN_SEARCH_UP				26		//	
#define IDX_BMP_BTN_SEARCH_DOWN				27		//	
#define IDX_BMP_MAX							28		//
...
#define	IDX_ICON_UP							8		//
#define	IDX_ICON_DOWN						9		//
#define	IDX_ICON_SEARCH						10		//
#define	IDX_ICON_REFRESH					11		//
#define IDX_ICON_ADD						12
#define IDX_ICON_SETUP						13
#define IDX_ICON_MAX						14		//
